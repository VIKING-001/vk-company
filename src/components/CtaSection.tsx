    ...
    >
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div
          ...
          style={{ background: "radial-gradient(ellipse 80% 100% at 50% 0%, rgba(254,196,17,0.05) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <div className="relative max-w-[900px] mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[0.92rem] text-white/45 leading-[1.85] max-w-[360px]">
          ...
          {/* Card */}
          <div className="border border-white/6 bg-secondary/50 p-8 lg:p-10">
            <ul className="space-y-4 mb-10" role="list">
              {features.map((f) => (
                <li key={f} className="flex items-start gap-3 text-[0.9rem] text-white/65 leading-snug">
                  <CheckCircle size={15} className="text-primary mt-0.5 flex-shrink-0" strokeWidth={2} />
                  {f}
                </li>
              ))}
            </ul>
            ...
            <motion.a
              ...
              className="group relative flex items-center justify-between gap-4 bg-primary text-primary-foreground font-bold text-[0.8rem] tracking-[0.14em] uppercase px-8 py-5 overflow-hidden w-full shadow-[0_8px_30px_rgba(254,196,17,0.18)] hover:shadow-[0_14px_40px_rgba(254,196,17,0.3)] transition-shadow duration-300"
            >
              ...
              <span className="relative z-10 text-primary-foreground/50 group-hover:text-primary-foreground group-hover:translate-x-1 transition-all duration-300">
                →
              </span>
            </motion.a>

            <p className="text-[0.67rem] text-white/20 tracking-wide mt-4 text-center">
