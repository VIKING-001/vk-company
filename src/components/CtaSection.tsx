...
const CtaSection = () => {
  return (
    <section
      ...
      className="px-[5vw] py-12 md:py-[12vh] border-t border-white/5 bg-background text-center relative overflow-hidden"
    >
      <div
        className="absolute inset-0"
        aria-hidden="true"
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(201,162,77,0.04) 0%, transparent 70%)'
        }}
      />
      ...
      >
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-3 bg-primary text-primary-foreground font-bold text-[0.85rem] tracking-[0.14em] uppercase px-11 py-5 hover:shadow-[0_12px_40px_rgba(201,162,77,0.35)] transition-shadow duration-300"
        >
