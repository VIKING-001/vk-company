...
const CybercoreBackground: React.FC<CybercoreBackgroundProps> = ({
    ...
    return (
        <div className="cybercore-scene" role="img" aria-label="Background animado com grid dourado">
